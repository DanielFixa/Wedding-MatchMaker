...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center">
            ...
            <div className="relative glass-panel p-8 rounded-2xl shadow-2xl w-full max-w-md mx-4 animate-in fade-in zoom-in duration-500">
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-serif text-gold mb-2">Wedding Matchmaker</h1>
                    <p className="text-gray-600 dark:text-gray-200">Plan your dream wedding together</p>
                </div>
